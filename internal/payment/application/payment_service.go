...
func NewPaymentService(payments PaymentRepository, events EventPublisher, log *logger.Logger) *PaymentService {
	return &PaymentService{payments: payments, events: events, log: log}
}
...
// Initiate creates a new payment record.
